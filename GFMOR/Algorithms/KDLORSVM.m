classdef KDLORSVM < Algorithm
    ...
    methods
        ...
        function obj = KDLORSVM(kernel, opt)
        ...
        function [model_information] = runAlgorithm(obj,train, test, parameters)
            ...
            %
            %                 model_information.model.projection = projection;
            %                 model_information.model.thresholds = thresholds;
            %                 model_information.model.kernel = obj.kernelType;
            %                 model_information.model.parameters = param;
            %                 model_information.model.algorithm = 'KDLOR';
        ...
        function [model]= train( obj,trainPatterns, trainTargets , parameters)
            ...
            switch upper(obj.optimizationMethod)
                case 'QUADPROG'
                    [alpha] = quadprog(Q,c,A,b,E,d,vlb,vub,x0,options);
                case 'CVX'
                    %                         rmpath ../cvx/sets
                    %                         rmpath ../cvx/keywords
                    %                         addpath ../cvx
            ...
            algoritmo_aux = SVORIM;
            projected = projection'*kernelMatrix;
            train_aux.patterns = projected';
            train_aux.targets = trainTargets';
            
            param.C = parameters.C;
            param.k = 1;
            modelo = algoritmo_aux.train(train_aux,train_aux,param);
            thresholds = (modelo.thresholds ./ (modelo.projection * projected'))';
            
            model.projection = projection;
            model.thresholds = thresholds;
            model.parameters = parameters;
            model.kernelType = obj.kernelType;
            model.algorithm = 'KDLORSVM';

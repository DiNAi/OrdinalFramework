classdef GOESim < Algorithm
    ...
    methods
        ...
        function obj = GOESim(kernel, opt)
             ...
             pesos = zeros(nOfClasses,1);
               ...
               for i = 1:nOfClasses,
                   ...
                   %% Train
                    ...
                    auxtrain.targets = etiquetas;
                    
                   [model_information]= obj.base_algorithm.runAlgorithm(auxtrain, test, parameters);  
                   
                   probTrain = obj.calculateProbabilities(model_information.projectedTrain', model_information.thresholds);
                   probTest = obj.calculateProbabilities(model_information.projectedTest', model_information.thresholds);

                   if i==1,
                        prob_pertenencia_claseTrain(1,:) = probTrain(1,:);
                        prob_pertenencia_claseTest(1,:) = probTest(1,:);
                   else
                        prob_pertenencia_claseTrain(i,:) = probTrain(2,:);
                        prob_pertenencia_claseTest(i,:) = probTest(2,:);
                   end
                ...
                model_information.projection = model_information.projection;
                model_information.trainTime = trainTime;
                model_information.testTime = testTime;
                model_information.parameters = parameters;
                model_information.projectedTest = model_information.projectedTest;
                model_information.projectedTrain = model_information.projectedTrain;
                model_information.thresholds = model_information.thresholds;

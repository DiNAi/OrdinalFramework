classdef AdaBoostORELMC2 < Algorithm
    ...
    methods
        ...
        function obj = AdaBoostORELMC2(opt)
            obj.name = 'AdaBoost and ELM Ordinal Regression (C2 Cost)';
        ...
        function [model]= train( obj,train,parameters)
                    ...
                    model.algorithm = 'AdaBoost.OR(ELM)-C2';

classdef SVORIMLIBSVM < Algorithm
    ...
    methods
        ...
        function obj = SVORIMLIBSVM(kernel)
            obj.name = 'Support Vector Machines for Ordinal Regression with Implicit Constraints but using LIBSVM (SVORIMLIBSVM)';
            if(nargin ~= 0)
